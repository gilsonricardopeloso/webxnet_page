  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        <h2 className="mt-8 text-4xl font-bold mb-4">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-12">
          <div className="p-4 bg-white shadow rounded-2xl">
            <h3 className="font-semibold text-xl mb-2">🎯 Definir Objetivos</h3>
            <p className="text-sm text-gray-600">
              Entenda para onde sua empresa quer ir.
            </p>
          </div>
          <div className="p-4 bg-white shadow rounded-2xl">
            <h3 className="font-semibold text-xl mb-2">📥 Coleta de Dados</h3>
            <p className="text-sm text-gray-600">
              Reunimos informações sobre mercado e concorrência.
            </p>
          </div>
          <div className="p-4 bg-white shadow rounded-2xl">
            <h3 className="font-semibold text-xl mb-2">🌐 Presença Online</h3>
            <p className="text-sm text-gray-600">
